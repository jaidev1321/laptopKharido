                        ...
                        <ul class="accordion-menu">
                            <li class="active-page">
							 ...
							 <li>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="<?php echo base_url('master/category'); ?>">Category</a></li>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>Product</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="<?php echo base_url('product/add_product'); ?>">Add Product</a></li>
                                    <li><a href="ui-buttons.html">List Product</a></li>
                                </ul>
                            </li>
                           <!--  <li>
                                <a href="javascript:void(0)">
